...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        KC_SLEP, QK_BOOT, KC_WAKE, KC_F21,  KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_DEL,
        ...
        KC_END,  KC_DOWN, KC_PGDN, KC_COMM, KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,   KC_RCTL,
        KC_PMNS, KC_PSLS, TG(1),   KC_ENT,  KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,  KC_SPC,  KC_LALT, TG(2),   KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [1] = LAYOUT(
        ...
        KC_PPLS, KC_PAST, DF(0),   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),
    [2] = LAYOUT(
        _______, _______, _______, _______, KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_END,
