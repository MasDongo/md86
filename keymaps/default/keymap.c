...
bool oled_task_user() {
    ...
    switch (get_highest_layer(layer_state)){
           ...
           case _STD:
            oled_write_P(led_state.caps_lock ? PSTR("Default       Caps On") : PSTR("Default      Caps Off"), false);
            break;
        case _NUM:
            oled_write_P(led_state.caps_lock ? PSTR("Numeric On    Caps On") : PSTR("Numeric On   Caps Off"), false);
            break;
        case _FUN:
            oled_write_P(led_state.caps_lock ? PSTR("Function      Caps On") : PSTR("Function     Caps Off"), false);
            break;
        }
